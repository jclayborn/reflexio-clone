...
function buildMirror(xPos, mirrorWidth, yPos, mirrorHeight, mirrorDrag){
    var dragMirror = mirrorDrag || 1;
    return{
      x: xPos*(width/1220),
      width: mirrorWidth*(width/1220),
      y: yPos*(width/1220),
      height: mirrorHeight*(width/1220),
      drag: dragMirror
    };
}

function buildStationaryAsteroid(xPos, yPos){
    return{
      x: xPos*(width/1220),
			y: yPos*(width/1220)
		};
...
function buildSpaceStation(xPos, yPos, ssFh){
    var stationFh = ssFh || 100;
    return{
      x: xPos*(width/1220),
      y: yPos*(width/1220),
      fh: stationFh
...
function initialiseLevel()
{
    if(levelNumber == 1)
	{
		...
		mySpacestation = buildSpaceStation(midx-70,100,100);
    ss.push(mySpacestation);
		myMirror = buildMirror(200,100,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror =buildMirror(600,100,400,-100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myAsteroid = buildStationaryAsteroid(1000,100);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(1000,200);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(1100,240);
		a.push(myAsteroid);
	...
	else if(levelNumber == 2)
	{
		...
		ey = 80*(width/1220);
		eh = 100*(width/1220);
		mySpacestation = buildSpaceStation(midx+100, 60, 100);
    ss.push(mySpacestation);
		myMirror = buildMirror(200,0,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(600,0,400,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(600,0,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(100,4,250,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		mirrorCount = mirrors.length;
		CircMirrorCount = CircMirrors.length;
	...
	else if(levelNumber == 3)
	{
		...
		ey = 20*(width/1220);
		eh = 100;
		mySpacestation = buildSpaceStation(midx*1.5,200,100);
    ss.push(mySpacestation);
		myMirror = buildMirror(200,0,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
	...
	else if(levelNumber == 4)
	{
		...
		ey = 60*(width/1220);
		eh = 100;
		mySpacestation = buildSpaceStation(mix-20,midy-40);
    ss.push(mySpacestation);
		myMirror = buildMirror(200,0,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(600,0,420,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(700,0,150,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(100,4,250,100);
		mirrors.push(myMirror);
		...
		myAsteroid = buildStationaryAsteroid(1100,250);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(300,300);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(1100,150);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(400,350);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(400,250);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(500,300);
		a.push(myAsteroid);
		mirrorCount = mirrors.length;
		CircMirrorCount = CircMirrors.length;
		init = true;
	...
	else if(levelNumber == 5)
	{
		...
		ey = 90*(width/1220);
		eh = 100;
		mySpacestation = buildSpaceStation(180,midy-40,100);
    ss.push(mySpacestation);
		myMirror = buildMirror(150,100,midy+200,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(800,100,midy-100,-150);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(700,0,400,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(900,100,500,0);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myAsteroid = buildStationaryAsteroid(5,220);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(78,190);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(130,120);
		a.push(myAsteroid);
	...
	else if(levelNumber == 6)
	{
		...
		ey = 90*(width/1220);
		eh = 100;
		mySpacestation = buildSpaceStation(midx,midy-230);
    ss.push(mySpacestation);
		myMirror = buildMirror(250,100,midy,100,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(1000,100,midy-100,70,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(10,16,midy+200,90, 1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(500,100,midy+290,-100, 0);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(450,100,midy-250,100,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myAsteroid = buildStationaryAsteroid(5,220);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(85,210);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(110, 130);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(100,270);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(midx-200,270);
		a.push(myAsteroid);
	...
	else if(levelNumber == 7)
	{
		...
		ey = 250*(width/1220);
		eh = 100;
		mySpacestation = buildSpaceStation(midx-400,55);
    ss.push(mySpacestation);
		myMirror = buildMirror(700,-15,360,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
		myMirror = buildMirror(30,13,500,100);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(900,100,200,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

    myMirror = buildMirror(500,35,175,1,0);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

    myAsteroid = buildStationaryAsteroid(80,180);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(115,250);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(110,335);
		a.push(myAsteroid);
		myAsteroid = buildStationaryAsteroid(50,385);
		a.push(myAsteroid);
	...
	else if(levelNumber == 8)
	{
		...
		ey = 525*(width/1220);
		eh = 100;
    mySpacestation = buildSpaceStation(midx-70,250);
    ss.push(mySpacestation);
		myMirror = buildMirror(200,-18,510,100,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(270,100,620,0,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(1100,95,530,-100,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(1200,-95,150,-100,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(20,50,130,-90,1);
		mirrors.push(myMirror);
		mirrorDrag.push(false);

		myMirror = buildMirror(450,50,520,0,0);
		mirrors.push(myMirror);
		mirrorDrag.push(false);
